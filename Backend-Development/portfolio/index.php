...
<div id="Project">
    ...
    <div class="container">
        <div class="row row-cols-1 row-cols-md-3 g-4">
            <div class="col">
                <div class="card shadow">
                    <img src="images/blog.png" class="card-img-top" alt="Project One">
                    <div class="card-body">
                        <h5 class="card-title text-center">Project Blog</h5>
            ...
            <div class="col">
                <div class="card shadow">
                    <img src="images/dashboard.png" class="img-fluid card-img-top" alt="Project Two">
                    <div class="card-body">
                        <h5 class="card-title text-center">Project Dashboard</h5>
                        <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                        <a href="#" class="btn btn-outline-dark">Github</a>
                    </div>
                </div>
            ...
            <div class="col">
                <div class="card shadow">
                    <img src="images/gallery.png" class="card-img-top" alt="Project Three">
                    <div class="card-body">
                        <h5 class="card-title text-center">Project Gallery</h5>
                        <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                        <a href="#" class="btn btn-outline-dark">Github</a>
                    </div>
                </div>
